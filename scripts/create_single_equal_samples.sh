...
# note that you create this file first based on the references you randomly
# pick for each sample
...
exec >> "log/${sample_name}/create_samples.log"
exec 2>&1
...
for cov in ${coverages[@]}; do
    ...
    for ref in ${ref_paths[@]}; do
        ...
        art_illumina -ss HS25 -na -i ${ref} -f ${cov} \
            -l 100 -m 200 -s 10 -o ${tmp_dir}/${ref_name%fna}
    done
